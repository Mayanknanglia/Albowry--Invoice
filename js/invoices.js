// ═══════════════════════════════════════════════════════
// AL BOWRY CARPENTRY LLC - Invoices Module
// ═══════════════════════════════════════════════════════
...
function saveInvoice(invoiceId) {
    ...
    let invoices = DB.get(DB_KEYS.INVOICES);
    if (invoiceId) {
    ...
    showToast(`Invoice ${invoiceId ? 'updated' : 'created'}!`, 'success');
    renderInvoices(document.getElementById('pageContainer'));
}
...
// View Invoice (Print Preview style)
